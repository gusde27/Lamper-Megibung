...
<div class="container" style="margin-top:25px">
  ...
  <strong>WELCOME TO MOUNTAIN PAGE!</strong> Enjoy all kinds of mountains that we have explored in Lombok
  </div>
...
<?php 
  ...
  $result = mysqli_query($koneksi,"SELECT * FROM postingan WHERE TIPE='Mountain'");
  $total = mysqli_num_rows($result);
  $pages = ceil($total/$halaman);            
  $data = mysqli_query($koneksi,"SELECT * FROM postingan WHERE TIPE='Mountain' LIMIT $mulai, $halaman");
  $no = 1;
