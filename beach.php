...
<div class="container" style="margin-top:25px">
  ...
  <strong>WELCOME TO BEACH PAGE!</strong> Enjoy all kinds of beaches that we have explored in Lombok
  </div>
...
<?php 
  ...
  $result = mysqli_query($koneksi,"SELECT * FROM postingan WHERE TIPE='Beach'");
  $total = mysqli_num_rows($result);
  $pages = ceil($total/$halaman);            
  $data = mysqli_query($koneksi,"SELECT * FROM postingan WHERE TIPE='Beach' LIMIT $mulai, $halaman");
  $no = 1;
