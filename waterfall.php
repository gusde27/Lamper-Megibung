...
<div class="container" style="margin-top:25px">
  ...
  <strong>WELCOME TO WATERFALL PAGE!</strong> Enjoy all kinds of waterfalls that we have explored in Lombok
  </div>
...
<?php 
  ...
  $result = mysqli_query($koneksi,"SELECT * FROM postingan WHERE TIPE='Waterfall'");
  $total = mysqli_num_rows($result);
  $pages = ceil($total/$halaman);            
  $data = mysqli_query($koneksi,"SELECT * FROM postingan WHERE TIPE='Waterfall' LIMIT $mulai, $halaman");
  $no = 1;
