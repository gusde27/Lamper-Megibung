...
<div class="container" style="margin-top:30px">
  ...
  <strong>WELCOME TO AGENT PAGE!</strong> You can see our agents profile
  </div>
    ...
    <div class="col-sm-8">
      <h3>Our Agent</h3>
          ...
          <table class="table table-bordered">
            ...
            <?php
            $data = mysqli_query($koneksi,"SELECT * FROM user WHERE LEVEL = 2 ");
            ...
            <tr>
              <td>
                <img src="foto/agent/<?php echo $d['FOTO']; ?>" widht="200" height="200">
              </td>
              <td>
                <h3 class="card-title"><?php echo $d['NAME']; ?></h3>
                <h5 class="card-text"><?php echo $d['JK']; ?></h5>
                <p class="card-text"><?php echo $d['NICKNAME']; ?></p>
                ...
                <a href="produk.php?NAME=<?php echo $d['USERNAME']; ?>">
                <button class="btn btn-primary btn-sm">Cek Produk</button>
                </a>
              </td>
            </tr>
            </tbody>
