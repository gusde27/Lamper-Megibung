...
$path = "foto/event/".$nama_file;
$path2 = "foto/event/".$nama_file2;
$path3 = "foto/event/".$nama_file3;
$path4 = "foto/event/".$nama_file4;
$path5 = "foto/event/".$nama_file5;
...
if(	$tipe_file == "image/jpeg" || $tipe_file == "image/png" && 
  ...
  if($ukuran_file <= 10000000 && 
    ...
    $query = "INSERT INTO event (USER, FOTO_E, FOTO_E2, FOTO_E3, FOTO_E4, FOTO_E5, NAMA_E, TANGGAL_E, DESKRIPSI) VALUES ('$user', '$nama_file', '$nama_file2', '$nama_file3', '$nama_file4', '$nama_file5', '$nama_e', '$tanggal', '$deskripsi')";
